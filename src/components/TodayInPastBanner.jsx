      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <div style={{
            ...
            color: theme.monthColor, marginBottom: '6px',
            ...
            >
              <div style={{
                ...
                <span style={{
                  ...
                  color: theme.subColor, fontFamily: 'monospace',
                }}>
                  {currentYear - year}年前
                </span>
              </div>
              ...
              {events.map((ev, i) => (
                ...
                >
                  <div style={{
                    fontSize: '10px', color: theme.subColor,
                    flexShrink: 0, paddingTop: '2px', minWidth: '34px',
                  }}>
                    {ev.h === '終日' ? '終日' : ev.h}
                  </div>
                  <div style={{
                    fontSize: '13px', color: theme.eventColor,
